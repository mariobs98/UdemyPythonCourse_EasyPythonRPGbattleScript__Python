...
# Instantiate People
player1 = Person("Marius:", 3200, 120, 300, 30, player_spells, player_items)
player2 = Person("Ragnar:", 1200, 250, 311, 16, player_spells, player_items)
player3 = Person("nadya :", 2600, 140, 235, 45, player_spells, player_items)

enemy1 = Person("Lag  ", 1250, 130, 560, 325, enemy_spells, [])
enemy2 = Person("Net  ", 18200, 701, 525, 25, enemy_spells, [])
enemy3 = Person("Cpu  ", 1250, 130, 560, 325, enemy_spells, [])
